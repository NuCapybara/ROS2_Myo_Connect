...
static const _EmgArray_type_support_symbol_names_t _EmgArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, myo_interfaces, msg, EmgArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, myo_interfaces, msg, EmgArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, myo_interfaces, msg, EmgArray)() {
  return &::myo_interfaces::msg::rosidl_typesupport_c::EmgArray_message_type_support_handle;
}
